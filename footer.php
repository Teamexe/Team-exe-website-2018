<section class="global-page-header">
        ...
        <footer id="footer">
            <div class="container">
                <div class="col-md-8">
                    <p class="copyright">&copy;: <span>2020</span> | Handcrafted with <span style="color: #FF0000; font-size: 25px;">&hearts;</span> by <b><a href="index.php" title="Team EXE official website">Team .EXE</a></b></p>
                </div>
                <div class="col-md-4">
                    <!-- Social Media -->
                    <ul class="social">
